...
ActiveRecord::Schema.define(version: 2024_09_10_150409) do
  ...
  create_table "nyanko_tags", force: :cascade do |t|
    t.integer "nyanko_id", null: false
    t.integer "tag_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["nyanko_id"], name: "index_nyanko_tags_on_nyanko_id"
    t.index ["tag_id"], name: "index_nyanko_tags_on_tag_id"
  end
  ...
  create_table "nyankograms", force: :cascade do |t|
    t.text "post_body"
    t.string "post_image"
    t.integer "user_id"
    t.datetime "created_at", precision: 6, null: false
  ...
  add_foreign_key "nyanko_tags", "nyankos"
  add_foreign_key "nyanko_tags", "tags"
end
